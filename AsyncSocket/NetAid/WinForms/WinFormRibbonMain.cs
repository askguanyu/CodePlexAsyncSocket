...
namespace GY.NetAid.WinForms
{
    ...
    public partial class WinFormRibbonMain : Form
    {
        public WinFormRibbonMain()
        {
            ...
            this.serverModePanel1.SendPanel.SendButton.Click+=new EventHandler(SendButton_Click);
        }

        void SendButton_Click(object sender, EventArgs e)
        {
            this.serverModePanel1.SendPanel.XMLTextBox.Text = Guid.NewGuid().ToString();
        }
